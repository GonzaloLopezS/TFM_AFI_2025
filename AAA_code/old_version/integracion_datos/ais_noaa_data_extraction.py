...
zip_filenames = [f"{base_name}_{str(i).zfill(2)}.zip" for i in range(1, 10)]
...
for i in zip_filenames:
    ...
    csv_filename, zip_filename = download_zip(file_link, path_to_zip_file, url) #o url+zip_filenames
    ...
    data_transformation(dataframe_csv, cargo_vessels, csv_filename, directory)
